...
import picture1 from '../../components/assets/englishClassesIndividual1.jpg';
import picture2 from '../../components/assets/englishClassesIndividual2.jpg';
...
const EnglishClassesIndividual = () => (
  <div>
    ...
    <PictureRightTextLeft picture={picture2} data={data3} />
  </div>
)
